            ...
            <div class="card-body">
                <form method="POST" action="{{route('information.update',$information->id)}}" accept-charset="UTF-8" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="title" id="title" value="{{ $information->title }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 ">
                            <div class="mb-3">
                            <textarea name="content" class="textarea" placeholder="Place some text here" style="" rows="10">{{ $information->content }}</textarea>
                            </div>
                            @if ($errors && $errors->has('content'))
                                <p class="text-danger text-xs error-message">{{ $errors->first('content') }}</p>
                            @endif
                        </div>
                    </div>
