        ...
        <div class="contactform-wrap">
            <form action="#" class="form-validate">
                ...
                <p class="contactform-field contactform-text">
                    <label class="contactform-label">Họ tên</label><!-- NO SPACE --><span class="contactform-input"><input placeholder="Tên của bạn" type="text" name="name" data-required="text"></span>
                </p>
                <p class="contactform-field contactform-email">
                    <label class="contactform-label">E-mail</label><!-- NO SPACE --><span class="contactform-input"><input placeholder="E-mail của bạn" type="text" name="email" data-required="text" data-required-email="email"></span>
                </p>
